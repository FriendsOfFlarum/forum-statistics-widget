...
flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('fof-forum-statistics-widget', function () {
  flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default.a.extensionData["for"]('fof-forum-statistics-widget').registerSetting({
    label: flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans(translationPrefix + 'widget_ignore_private_discussions_label'),
    setting: 'fof-forum-statistics-widget.ignore_private_discussions',
    type: 'switch'
  }).registerSetting({
    label: flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans(translationPrefix + 'widget_order_label'),
    setting: 'fof-forum-statistics-widget.widget_order',
    type: 'number',
    help: flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans(translationPrefix + 'widget_helper_text')
  }).registerPermission({
