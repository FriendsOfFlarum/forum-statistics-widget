...
/* harmony import */ var flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! flarum/common/utils/formatNumber */ "flarum/common/utils/formatNumber");
/* harmony import */ var flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3__);
...
var ForumStatisticsWidget = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    var discussionsCount = flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3___default()(app.forum.attribute(attributePrefix + 'discussionsCount'));
    var postsCount = flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3___default()(app.forum.attribute(attributePrefix + 'postsCount'));
    var usersCount = flarum_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_3___default()(app.forum.attribute(attributePrefix + 'usersCount'));
    var user = {
      displayName: flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(app.forum.attribute(attributePrefix + 'lastUser')),
      slug: flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(app.forum.attribute(attributePrefix + 'lastUser'))
    };
    return m("div", {
    ...
    }), " ", app.translator.trans(translationPrefix + 'widget_title')), m("div", null, m("ul", {
      id: "ForumStatisticsList"
    }, m("li", null, app.translator.trans(translationPrefix + 'discussions_count', {
      discussionsCount: discussionsCount
    })), m("li", null, app.translator.trans(translationPrefix + 'posts_count', {
      postsCount: postsCount
    })), m("li", null, app.translator.trans(translationPrefix + 'users_count', {
      usersCount: usersCount
    })), m("li", null, app.translator.trans(translationPrefix + 'latest_member'), m(flarum_common_components_Link__WEBPACK_IMPORTED_MODULE_5___default.a, {
      href: app.route.user(user)
    }, m("strong", null, " ", flarum_common_helpers_username__WEBPACK_IMPORTED_MODULE_2___default()(user))))))));
  };
